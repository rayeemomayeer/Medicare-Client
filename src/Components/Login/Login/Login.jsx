  ...
  flex items-center justify-center  "
          >
            <div className="w-full h-100">
              <h1 className="text-xl md:text-2xl text-teal-700 font-bold leading-tight">
          ...
          focus:bg-white focus:outline-none"
                ...
                <button className="mt-2">
                  <span className="text-cyan-500 hover:text-cyan-700  font-base">
                    Forgot Password?
                  </span>
                </button>
                <div className="mt-4">
                ...
                <button
                  type="submit"
                  className="w-full block bg-teal-500 hover:bg-teal-400 focus:bg-indigo-400 text-white font-semibold rounded-lg
        px-4 py-3 mt-6"
                >
                  Log In
                </button>
